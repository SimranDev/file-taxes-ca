...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-orange-400  to-amber-500 text-white">
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-white hover:text-white transition-colors duration-200 text-sm flex items-center group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center">
                ...
                <a href={CONTACT.PHONE_HREF} className="text-white hover:text-white transition-colors duration-200">
                  {CONTACT.PHONE}
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href={`mailto:${CONTACT.EMAIL}`} className="text-white hover:text-white transition-colors duration-200">
                  {CONTACT.EMAIL}
                </a>
              </li>
              <li className="flex items-center">
                ...
                <span className="text-white">{CONTACT.BUSINESS_HOURS}</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 text-white mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                ...
                <span className="text-white">{CONTACT.SERVICE_AREA}</span>
              </li>
            </ul>
          </div>
        </div>
